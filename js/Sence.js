			...
			if(g.senceNumber==0){
				...
				var standard=0.1;
					if(standard>Math.random()){
						if(decoration<0){
							var fish=new Fish(_.random(1,5), g.canvas.width+50,rnd(0,g.canvas.height),rnd(91,269));
						}else{
							var fish=new Fish(_.random(1,5), -50,rnd(0,g.canvas.height),rnd(-89,89));
						}
						g.fishArr.push(fish);
					}
